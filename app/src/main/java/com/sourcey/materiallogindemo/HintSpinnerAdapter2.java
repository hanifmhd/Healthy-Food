 ...
 */
public class HintSpinnerAdapter2 implements SpinnerAdapter, ListAdapter {
     ...
     * @param context
     */
    public HintSpinnerAdapter2(SpinnerAdapter spinnerAdapter,
